...
public class CustomerAddress {
   ...
   * @return addressLine1
   */
  @ApiModelProperty(example = "3/1 XYZ avenue,", required = true, value = "")
  @NotNull
  @Size(max = 50)
   ...
   * @return addressLine2
   */
  @ApiModelProperty(example = "Boston, USA", value = "")
   ...
   * @return street
   */
  @ApiModelProperty(example = "Storrow Dr road", value = "")
   ...
   * @return postalCode
   */
  @ApiModelProperty(example = "02215", required = true, value = "")
  @NotNull
  @Size(min = 6)
